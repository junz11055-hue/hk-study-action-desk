...
const CAPTURE_ENTRY = fileURLToPath(
  new URL(
    "../../src/v2/phase2rd/phase2rd-candidate-capture.js",
    import.meta.url,
  ),
);
const EVALUATION_ENTRIES = [
  fileURLToPath(
    new URL(
      "../../src/v2/phase2rd/phase2rd-evaluation-runner.js",
      import.meta.url,
    ),
  ),
  fileURLToPath(
    new URL("../../src/v2/phase2rd/run-phase2rd-evaluate.js", import.meta.url),
  ),
];
...
const CAPTURE_BANNED_PATHS = [
  ...
  "/src/v2/phase2rd/phase2rd-evaluation-runner.js",
  "/src/v2/phase2rd/run-phase2rd-evaluate.js",
];
...
const EVALUATION_BANNED_PATHS = [
  ...
  "/src/v2/model/",
  "/src/v2/phase2rd/phase2rd-candidate-capture.js",
  "/src/v2/phase2rd/phase2rd-deepseek-config.js",
  "/src/v2/phase2rd/phase2rd-git-preflight.js",
  "/src/v2/phase2rd/run-phase2rd-deepseek.js",
];
...
test("Phase 2R-D Capture graph cannot reach expected truth, Oracle, evaluator, locked data, or services", async () => {
...
test("Phase 2R-D Evaluation graph cannot reach Key, config, provider client, network, listener, or child process", async () => {
  ...
  for (const [file, source] of graph) {
    assert.doesNotMatch(
      source,
      /\bprocess\.env\b|--env-file|dotenv(?:\/config|\.config)|loadPhase2rdDeepSeekConfig/u,
      file,
    );
    assert.doesNotMatch(
      source,
